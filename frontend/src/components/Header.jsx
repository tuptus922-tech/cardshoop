    ...
    <header className="sticky top-0 z-20 px-4 pt-3 pb-3 glass-panel border-b border-slate-800">
      ...
      <div className="flex items-center justify-between gap-3 mb-2.5">
        ...
        {user ? (
          ...
          <div className="flex items-center gap-1.5 bg-slate-800/60 border border-slate-700/40 rounded-full py-1 px-2.5 text-xs text-slate-300">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-8 py-2 bg-slate-900/90 border border-slate-700/70 rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 transition-colors shadow-inner"
        />
        {searchQuery && (
          <button
